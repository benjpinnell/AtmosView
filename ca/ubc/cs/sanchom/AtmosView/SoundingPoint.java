...
public class SoundingPoint implements Serializable, Comparable
{
	 ...
	 */
	public SoundingPoint(double millibars, double metres, double temperature, double dewpoint, double direction, double speed)
	{
	...
	public boolean equals( Object obj )
	{
		...
		return
		(this.m_millibars == that.m_millibars) &&
	 ...
	 * @return 1 if this SoundingPoint has a higher altitude that obj
	 * 0 if this SoundingPoint has the same altitude as obj, or
	 * -1 if this SoundingPoint has a lowe altitude than obj
	 */
	public int compareTo( Object obj ) throws ClassCastException
	{
		if ( !(obj instanceof SoundingPoint) )
			throw new ClassCastException("Passed object cannot be compared with object of type SoundingPoint");
		if ( equals(obj) )
			return 0;

		SoundingPoint that = (SoundingPoint)obj;
		
		if ( this.m_metres == that.m_metres )
			return 0;
